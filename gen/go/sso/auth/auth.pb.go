...
type IsAdminRequest struct {
	...
	UserUuid string `protobuf:"bytes,1,opt,name=user_uuid,json=userUuid,proto3" json:"user_uuid,omitempty"` // User ID to validate.
}
...
var file_sso_auth_auth_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x55, 0x75, 0x69, 0x64, 0x22, 0x57, 0x0a, 0x0c, 0x4c,
